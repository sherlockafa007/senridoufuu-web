...
import { getFirestore, collection, addDoc, doc, updateDoc, serverTimestamp } from 'https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js';
...
async function finish() {
  ...
  try { await updateDoc(visitRef, { duration }); } catch {}
  visitRef = null;
}
